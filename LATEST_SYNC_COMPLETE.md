...
- ✅ AUTO_DEPLOY_COMPLETE.md - 自动部署总结

### 配置 (6 个)
- ✅ requirements.txt - Python 依赖
- ✅ .env.example - 环境变量示例
- ✅ channels/cli.yaml - CLI 通道配置
- ✅ gateway/routes.yaml - 网关路由
...
- ✅ workspace/USER.md - 用户模型
- ✅ workspace/AGENTS.md - 协作规则
...
| 版本 | 日期 | 说明 |
|------|------|------|
| v0.3.1 | 2026-04-12 | 添加一键部署和自动启动系统 |
| v0.3.0 | 2026-04-12 | 初始版本 - Markdown 驱动的智能体 |
